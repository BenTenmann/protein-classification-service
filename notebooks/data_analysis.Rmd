...
Given the nature of the data and the problem, we need to build a multi-class classifier, which can take sequence data and produce a class label. Hence, there are two primary questions: 1) how to represent the data and 2) how to deal with the class imbalance.

I first deal with the data representation problem, creating a classifier based on the top $N$ 
